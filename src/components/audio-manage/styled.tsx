...
export const AudioManageContainer = styled.div<AudioManageContainerProps>`
  ...
  width: 360px;
  height: 100%;
  background: ${props => props.supportBackdopFilter ? transparentize(0.4, props.theme.colors.N800) : transparentize(0.1, props.theme.colors.N800)};
